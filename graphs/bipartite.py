## Checking for bipartiteness means finding cycles of odd length. 
...
## If we use DFS we need to find back edges which form cycles with odd length. 
## We will have a color array array with all values set to false. When we visit a neighbor we will invert its color from that of the parent
